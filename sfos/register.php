...
<div class="content h-100 d-flex w-100 justify-content-center align-items-center" style="padding-top:30px;">
                ...
                <form id="loginform" class="form-horizontal" role="form" method="POST" action="">
                    ...
                    <div class="text-center">
                        <div class="col-sm-12 controls">
                            <input type="submit" name="create" value="Create Account" class="btn rounded-6" style="background-color:#F8A19F;">
                        </div>
                    </div>
                    <div class="text-center">
                    <a href="./login.php" class="text-decoration-none" style="color:#BB0E00;">Already have an account?</a>
                    </div>
                </form>
            </div>
        </div>
